...
// Source: github.com/napLord/cnm-purchase-api/internal/app/repo (interfaces: EventRepo)
...
import (
	...
	model "github.com/napLord/cnm-purchase-api/internal/model"
)
...
func (m *MockEventRepo) Add(arg0 []model.PurchaseEvent) error {
	m.ctrl.T.Helper()
...
func (m *MockEventRepo) Lock(arg0 uint64) ([]model.PurchaseEvent, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "Lock", arg0)
	ret0, _ := ret[0].([]model.PurchaseEvent)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}
